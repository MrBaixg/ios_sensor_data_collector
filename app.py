        ...
        with self.con.cursor() as cur:
            for location_obj in location_records:
                try:
                    ...
                    cur.execute(sql, (time, id, longitude, latitude, altitude, time_gps, speed, course, accuracy_horizontal, accuracy_vertical))
                except pymysql.err.IntegrityError:
                    continue
                except Exception as e:
                    logger.exception(e)
        ...
        with self.con.cursor() as cur:
            for sensor_obj in sensor_records:
                try:
                    ...
                    cur.execute(sql, (time, id, accelerometerX, accelerometerY, accelerometerZ, gyroscopeDataX, gyroscopeDataY, gyroscopeDataZ, magnetometerX, magnetometerY, magnetometerZ))
                except pymysql.err.IntegrityError:
                    continue
                except Exception as e:
                    logger.exception(e)
